...
from . import nsfw_detector_pb2 as nsfw__detector__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in nsfw_detector_pb2_grpc.py depends on'
...
def add_NSFWDetectorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'nsfw_detector.NSFWDetector', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('nsfw_detector.NSFWDetector', rpc_method_handlers)
