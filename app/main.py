...
from app.errors.http import app_error_handler, http_error_handler, validation_error_handler
...
def create_app(
    *,
    ...
    nonce_repository: AuthNonceRepository | None = None,
    ...
    if nonce_repository is not None:
        app.state.auth_service = AuthService(resolved_settings, nonce_repository)
    else:
